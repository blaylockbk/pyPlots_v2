...
#==============================================================================
# Date range
sDATE = datetime(2017, 6, 17)
eDATE = datetime(2017, 7, 7)

# List of MesoWest stations
MesoWestID = ['TT047', 'TT048']

# Half box for area statistics
half_box = 9

# Directory to save figures (subdirectory will be created for each stnID)
SAVE_dir = '/uufs/chpc.utah.edu/common/home/u0553130/public_html/PhD/HRRR_fires/BRIANHEAD/'
