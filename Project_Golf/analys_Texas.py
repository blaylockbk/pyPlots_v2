...
# 1) Locations
location = {'OEST2': {'latitude': 32.97988,
                      'longitude': -101.83220,
                      'name': "O'Donnell 1N",
                      'is MesoWest': True,    # Is the Key a MesoWest ID?
                      'timezone': 5}         # Time Zone Hours to subtract form UTC
           }
...
for hh in range(len(TS_dates)):
    ...
    for loc in location.keys():
        ...
        SAVE = '/uufs/chpc.utah.edu/common/home/u0553130/public_html/PhD/HRRR/TexasBurn_2017-04-27/%s/' % loc
