# 16 June 2016
# !! Can't create these plots because I don't have the correct WRF out variable available for
#    shorter time steps in the auxhist file. Requires a re-run of WRF and editing the myoutfields.txt file
...
# Set directories
WRFDIR = '/uufs/chpc.utah.edu/common/home/horel-group4/model/bblaylock/WRF3.7_spinup/DATA/RESTART_June18-17:00--18-23:00/'
FIGDIR = '/uufs/chpc.utah.edu/common/home/u0553130/public_html/MS/crosssection/spinup/bothplumes/restart_plum_18Jun1700/forAMS2/'
if not os.path.exists(FIGDIR):
    os.makedirs(FIGDIR)


# create a range of times at an interval of the timestep in minutes. auxhis24 has a 10 minute output
model_start = datetime(2015,6,18,17)
